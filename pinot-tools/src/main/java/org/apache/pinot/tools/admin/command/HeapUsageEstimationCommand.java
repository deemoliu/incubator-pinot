...
public class HeapUsageEstimationCommand extends AbstractBaseAdminCommand implements Command {
  private static final Logger LOGGER = LoggerFactory.getLogger(HeapUsageEstimationCommand.class);
  ...
  @Option(name = "-tableName", required = true, metaVar = "<string>", usage = "Table name.")
  ...
  public String description() {
    return "Estimate the upsert keySpace in heap memory for table";
  }
  ...
  public String toString() {
    String retString = ("HeapUsageCommand -queryType " + _queryType + " -tableName " + _tableName);
  ...
  public HeapUsageEstimationCommand setTableName(String tableName) {
    _tableName = tableName;
    return this;
  }

  public HeapUsageEstimationCommand setExecute(boolean exec) {
    _exec = exec;
    return this;
  }
